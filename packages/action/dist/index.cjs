...
function hasFlag2(flag, argv = import_node_process2.default.argv) {
  const prefix = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
  const position = argv.indexOf(prefix + flag);
  const terminatorPosition = argv.indexOf("--");
  return position !== -1 && (terminatorPosition === -1 || position < terminatorPosition);
...
function hasFlag3(flag, argv = import_node_process5.default.argv) {
  const prefix = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
  const position = argv.indexOf(prefix + flag);
  const terminatorPosition = argv.indexOf("--");
  return position !== -1 && (terminatorPosition === -1 || position < terminatorPosition);
...
var import_node_process5, import_node_os3, import_node_tty3, env3, flagForceColor3, supportsColor3, supports_color_default3;
var init_supports_color3 = __esm({
  "../../node_modules/log-symbols/node_modules/chalk/source/vendor/supports-color/index.js"() {
    ...
    ({ env: env3 } = import_node_process5.default);
    ...
    supportsColor3 = {
      stdout: createSupportsColor3({ isTTY: import_node_tty3.default.isatty(1) }),
      stderr: createSupportsColor3({ isTTY: import_node_tty3.default.isatty(2) })
    };
...
var require_safe_buffer = __commonJS({
  "../../node_modules/bl/node_modules/safe-buffer/index.js"(exports, module2) {
...
var import_node_process7, import_node_readline, import_bl, ASCII_ETX_CODE, StdinDiscarder, stdinDiscarder, stdin_discarder_default;
      ...
      constructor() {
        ...
        this.#ourEmit = function(event, data, ...arguments_) {
          ...
          if (self.#requests > 0 || stdin.emit === self.#ourEmit) {
            ...
            Reflect.apply(import_node_process7.default.stdin.emit, this, [event, data, ...arguments_]);
          }
        };
      }
      start() {
...
var import_node_process8, import_cli_spinners, import_wcwidth, import_cli_spinners2, Ora;
var init_ora = __esm({
  "../../node_modules/ora/index.js"() {
...
function toPathName(filename, root) {
  return typeof root.__dirname !== "undefined" ? (0, import_node_path.join)(root.__dirname, filename) : new import_node_url.URL(filename, root.importUrl).pathname;
}
var import_node_path, import_node_url, messages, encounteredErrors;
var init_io = __esm({
  "../core/dist/io.js"() {
    "use strict";
    init_source();
...
async function readFile({ path: path5 }) {
  return import_node_fs.default.promises.readFile(path5, "utf8");
}
async function writeFile({ path: path5, contents }) {
  await createDirectory({ directory: (0, import_node_path2.dirname)(path5) });
  debug(`writing "${contents}" to "${path5}"`);
  return import_node_fs.default.promises.writeFile(path5, `${contents.trim()}${import_node_os4.default.EOL}`, "utf8");
}
async function copyFile({ from, to }) {
  await createDirectory({ directory: (0, import_node_path2.dirname)(to) });
  return import_node_fs.default.promises.copyFile(from, to);
}
async function removeFile({ path: path5 }) {
  return import_node_fs.default.promises.rm(path5);
}
async function isAccessibleFile({ path: path5, mode }) {
  try {
    await import_node_fs.default.promises.access(path5, mode);
    return true;
  } catch {
    return false;
  }
...
async function isReadableAndWritableFile({ path: path5 }) {
  return isAccessibleFile({
    path: path5,
    mode: import_node_fs.default.constants.R_OK | import_node_fs.default.constants.W_OK
  });
}
var import_node_fs, import_node_os4, import_node_path2;
var init_file = __esm({
  "../core/dist/file.js"() {
    "use strict";
...
async function removeDirectory({ directory }) {
  return import_node_fs2.default.promises.rm(directory, { recursive: true });
}
async function createDirectory({ directory }) {
  return import_node_fs2.default.promises.mkdir(directory, { recursive: true });
}
async function isDirectory({ directory }) {
  try {
    return (await import_node_fs2.default.promises.stat(directory)).isDirectory();
  } catch {
    return false;
  }
}
...
async function readGitignore({ directory }) {
  return (await readFile({ path: (0, import_node_path3.resolve)(directory, FILENAME) })).trim().split(import_node_os5.default.EOL);
}
async function writeGitignore({ directory, lines, append = true }) {
  const path5 = (0, import_node_path3.resolve)(directory, FILENAME);
  ...
  return writeFile({
    path: path5,
    contents: lines.join(import_node_os5.default.EOL)
  });
}
var import_node_os5, import_node_path3, FILENAME;
...
async function exec(cmd, args = [], { cwd = process.cwd(), env: env4 = process.env, io = "return" } = {}) {
  ...
  const child = import_node_child_process.default.spawn(cmd, args, {
    shell: true,
...
var require_sort_object_keys = __commonJS({
  "../../node_modules/sort-object-keys/index.js"(exports, module2) {
...
var import_node_fs3, import_meta, dataFile, gitHooks, git_hooks_list_default;
var init_git_hooks_list = __esm({
  "../../node_modules/git-hooks-list/index.js"() {
    import_node_fs3 = __toESM(require("fs"), 1);
    import_meta = {};
    dataFile = new URL("./index.json", import_meta.url);
    gitHooks = JSON.parse(import_node_fs3.default.readFileSync(dataFile));
...
async function hasPackage({ directory }) {
  return isReadableAndWritableFile({ path: (0, import_node_path4.resolve)(directory, FILENAME2) });
}
async function readPackage({ directory }) {
  return readJson({ path: (0, import_node_path4.resolve)(directory, FILENAME2) });
}
async function writePackage({ directory, data, append = true }) {
  await writeJson({ path: (0, import_node_path4.resolve)(directory, FILENAME2), data, append });
  await sortPackage({ directory });
}
async function updatePackage({ directory, merge }) {
  await updateJson({ path: (0, import_node_path4.resolve)(directory, FILENAME2), merge });
  await sortPackage({ directory });
}
async function sortPackage({ directory }) {
  debug(`sorting "package.json" in "${directory}"`);
  await updateJson({
    path: (0, import_node_path4.resolve)(directory, FILENAME2),
    merge: sort_package_json_default
  });
}
var import_node_path4, FILENAME2;
...
var require_hosts = __commonJS({
  "../../node_modules/hosted-git-info/lib/hosts.js"(exports, module2) {
    "use strict";
...
var require_lib2 = __commonJS({
  "../../node_modules/hosted-git-info/lib/index.js"(exports, module2) {
    "use strict";
...
var require_spdx_simple = __commonJS({
  "../../node_modules/@ovyerus/licenses/spdx-simple.json"(exports, module2) {
    module2.exports = [
      "0BSD",
      "AAL",
      "ADSL",
...
var require_simple = __commonJS({
  "../../node_modules/@ovyerus/licenses/simple.js"(exports, module2) {
    "use strict";
    module2.exports = new Set(require_spdx_simple());
  }
});
...
var require_spdx = __commonJS({
  "../../node_modules/@ovyerus/licenses/spdx.json"(exports, module2) {
    module2.exports = {
      "0BSD": {
...
var require_licenses = __commonJS({
  "../../node_modules/@ovyerus/licenses/index.js"(exports, module2) {
    "use strict";
    module2.exports = require_spdx();
  }
});

// ../../node_modules/fuzzy-search/dist/FuzzySearch.js
var require_FuzzySearch = __commonJS({
  "../../node_modules/fuzzy-search/dist/FuzzySearch.js"(exports, module2) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module2 ? module2.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.FuzzySearch = t() : e.FuzzySearch = t();
...
async function locatePath(paths, {
  ...
  return pLocate(paths, async (path_) => {
    try {
      const stat = await statFunction(import_node_path5.default.resolve(cwd, path_));
...
var import_node_process9, import_node_path5, import_node_fs4, import_node_url2, typeMappings, matchType, toPath;
var init_locate_path = __esm({
  "../../node_modules/locate-path/index.js"() {
    ...
    toPath = (urlOrPath) => urlOrPath instanceof URL ? (0, import_node_url2.fileURLToPath)(urlOrPath) : urlOrPath;
  }
});
...
async function findUpMultiple(name, options = {}) {
  ...
  const stopAt = import_node_path6.default.resolve(directory, options.stopAt || root);
...
var import_node_path6, import_node_url3, toPath2, findUpStop;
var init_find_up = __esm({
  "../../node_modules/pkg-up/node_modules/find-up/index.js"() {
    ...
    init_locate_path();
    init_path_exists();
    toPath2 = (urlOrPath) => urlOrPath instanceof URL ? (0, import_node_url3.fileURLToPath)(urlOrPath) : urlOrPath;
...
async function getMonorepoDirectory({ directory }) {
  const path5 = await pkgUp({ cwd: (0, import_node_path7.dirname)(directory) });
  if (!path5) {
    return;
  }
  const parentPackageDirectory = (0, import_node_path7.dirname)(path5);
...
async function isRepo({ directory }) {
  return await isDirectory({ directory: (0, import_node_path8.join)(directory, ".git") }) && await hasPackage({ directory });
}
var import_hosted_git_info, import_node_path8;
var init_repo = __esm({
  "../core/dist/repo.js"() {
    "use strict";
...
async function install({ directory }) {
  await writeYaml({
    path: (0, import_node_path9.join)(directory, FILENAME3),
    data: {
      version: 2,
      updates: [
        {
...
async function remove({ directory }) {
  await removeFile({ path: (0, import_node_path9.join)(directory, FILENAME3) });
}
async function load({ directory }) {
  const path5 = (0, import_node_path9.join)(directory, FILENAME3);
...
var import_node_path9, FILENAME3, dependabot;
...
async function readDevcontainerJson({ directory }) {
  return readJson({
    path: (0, import_node_path10.join)(directory, FILENAME4)
  });
}
async function writeDevcontainerJson({ directory, data }) {
  await writeJson({ path: (0, import_node_path10.join)(directory, FILENAME4), data });
}
async function removeDevcontainerJson({ directory }) {
  await removeFile({ path: (0, import_node_path10.join)(directory, FILENAME4) });
}
var import_node_path10, FILENAME4;
...
async function remove3({ directory }) {
  ...
  await removeDirectory({ directory: (0, import_node_path11.join)(directory, ".husky") });
...
function getPreCommitHookPath({ directory }) {
  return (0, import_node_path11.join)(directory, PRE_COMMIT_HOOK_FILE);
}
async function getPreCommitHookCommands({ directory }) {
  ...
  return (await readFile({
    path: getPreCommitHookPath({ directory })
  })).trim().split(import_node_os6.default.EOL).filter((line) => line !== "");
}
async function setPreCommitHookCommands({ directory, commands }) {
  return writeFile({
    path: getPreCommitHookPath({ directory }),
    contents: commands.join(import_node_os6.default.EOL)
  });
}
...
var import_node_os6, import_node_path11, PRE_COMMIT_HOOK_FILE, husky;
...
async function install6({ directory }) {
  const workflowDirectory = (0, import_node_path12.join)(directory, WORKFLOWS_DIRECTORY);
  await copyFile({
    from: toPathName("../../static/ci.yml", {
      __dirname,
      importUrl: import_meta2.url
    }),
    to: (0, import_node_path12.join)(workflowDirectory, "ci.yml")
  });
  await copyFile({
    ...
    to: (0, import_node_path12.join)(workflowDirectory, "update-node-versions.yml")
  });
}
...
async function load6({ directory }) {
  ...
  if (await hasPlugin({ directory, name: "semantic-release" })) {
    await copyFile({
      ...
      to: (0, import_node_path12.join)(workflowDirectory, "release.yml")
    });
  }
  if (await hasPlugin({ directory, name: "prettier" })) {
    await copyFile({
      ...
      to: (0, import_node_path12.join)(workflowDirectory, "format-check.yml")
    });
  }
  if (await hasPlugin({ directory, name: "dependabot" })) {
    await copyFile({
      ...
      to: (0, import_node_path12.join)(workflowDirectory, "dependabot-automerge.yml")
    });
  }
}
var import_node_path12, import_meta2, WORKFLOWS_DIRECTORY, githubActions;
...
async function install7({ directory }) {
  ...
  if (!hasPlugin({ directory, name: "typescript" })) {
    ...
    await writeFile({
      path: (0, import_path.join)(directory, JEST_CONFIG_FILENAME),
...
async function remove7({ directory }) {
  ...
  try {
    await removeFile({ path: (0, import_path.join)(directory, JEST_CONFIG_FILENAME) });
  } catch {
  }
...
var import_path, JEST_CONFIG_FILENAME, TS_JEST_CONFIG, jest;
var init_jest = __esm({
  "../plugins/dist/jest/jest.js"() {
    "use strict";
    init_dist2();
...
async function writePrettierrc({ directory, data }) {
  await writeYaml({ path: import_node_path13.default.join(directory, FILENAME5), data });
}
async function removePrettierrc({ directory }) {
  await removeFile({ path: import_node_path13.default.join(directory, FILENAME5) });
}
var import_node_path13, FILENAME5;
...
async function install9({ directory }) {
  ...
  await writeFile({
    path: (0, import_node_path14.join)(directory, ".prettierignore"),
    contents: PRETTIER_IGNORE.join(import_node_os7.default.EOL)
  });
}
...
var import_node_os7, import_node_path14, PRETTIER_IGNORE, prettier;
...
async function install10({ directory }) {
  ...
  await writeJson({
    path: (0, import_node_path15.join)(directory, CONFIG_FILENAME),
    data: CONFIG
  });
  await writePackage({
    directory,
...
var import_node_path15, CONFIG_FILENAME, CONFIG, semanticRelease;
...
async function writeTsconfig({ directory, data }) {
  await writeJson({ path: import_node_path16.default.join(directory, FILENAME6), data });
}
async function removeTsconfig({ directory }) {
  await removeFile({ path: import_node_path16.default.join(directory, FILENAME6) });
}
var import_node_path16, FILENAME6;
